...
from processing.client.types import (
    FtsoDataResponse,
    FtsoRandomResponse,
    FtsoVotingResponse,
)
...
class FtsoClientTest(TestCase):
    ...
    def test_get_data(self):
        ...
        self.assertEqual(
            data_response.merkleRoot,
            "0x9124d58e40bb8ad0cfb8c022e49d103d487d4cf7a23d57077dd9d726e316730a",
        )
        ...
        self.assertEqual(
            data_response.random.value,
            "0x54f2ca3184ad459bc8e518496602f2bb1e414902a47e15a388a11b8255565f82",
        )
        ...
        self.assertEqual(
            ftso_voting_response.id, "0x01414156452f555344000000000000000000000000"
        )
...
class FtsoProcessorTest(TestCase):
    def setUp(self):
        ...
        self.FTSOprocessor = FtsoProcessor(
            ProtocolConfig(protocol_id=100, providers=[])
        )
        ...
        with patch(
            "processing.client.main.FtsoClient.get_data",
            return_value=self.parsed_response,
        ):
            processed_data = self.FTSOprocessor.process_single_provider(
                self.root, self.FTSOclient
            )
    ...
    def test_process_single_provider(self):
        ...
        self.assertEqual(
            rand.value,
            "54f2ca3184ad459bc8e518496602f2bb1e414902a47e15a388a11b8255565f82",
        )
    ...
    def test_process(self):
        with patch(
            "processing.ftso_processing.FtsoProcessor.fetch_merkle_tree",
            return_value=(self.rand, self.res),
        ):
        ...
        self.assertEqual(
            ...
            "9124d58e40bb8ad0cfb8c022e49d103d487d4cf7a23d57077dd9d726e316730a",
        )
