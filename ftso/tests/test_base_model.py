...
class FeedResultTestCase(TestCase):
    ...
    def test_feed_result_hash_1(self):
        ...
        self.assertEqual(
            ...
            "3340586f8ba8a0d651564de8b7615fa1f9f114ac24768e6dbc9ee055d1552372",
        )
    ...
    def test_feed_result_hash_2(self):
        ...
        self.assertEqual(
            feed_result.hash.hex(),
            "2cc51313f84c3da21d55bb4e4c52f8761d86e50fc867b78585db28d59fff0023",
        )
    ...
    def test_random_result_hash(self):
        ...
        self.assertEqual(
            ...
            "20542916096759045c2e8f7676f4d73c2fc4fe2297dd5f7fa37d1ae883ad7eb2",
        )
